...
class Text
  ...
  property :byte_order, Enum[:little, :big, :middle, :unknown], :default => :unknown
    # byte order
  ...
  property :pageOrder, Enum[:left_to_right, :right_to_left], :default => :left_to_right
    # The natural page turning order of the text
  property :pageSequence, Enum[:reading_order, :inverse_reading_order], :default => :reading_order
    # The arrangement of the page-level divs in the METS file.
  property :lineOrientation, Enum[:vertical, :horizontal], :default => :horizontal
