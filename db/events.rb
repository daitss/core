...
class Event
  ...
  belongs_to :agent
   ...
   def fromPremis premis
     ...
     attribute_set(:type, premis.find_first("premis:eventType", NAMESPACES).content)
     ...
     attribute_set(:outcome_details, premis.find_first("premis:eventOutcomeInformation/premis:eventOutcomeDetail", NAMESPACES).content)
   end
end
